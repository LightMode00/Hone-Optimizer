...
<h3 align="center">Hone-Optimizer</h3>

  <p align="center">
    Hone-Optimizer is a free and open source desktop utility that aims to improve FPS, reduce input lag, and optimize network performance for video game titles and day-to-day productivity.
</div>
...
To run the optimizer is easy, all you need to do is double click Hone-Optimizer.exe and run it as admin
...
Hone-Optimizer can be used on any PC running windows 10 and above.
